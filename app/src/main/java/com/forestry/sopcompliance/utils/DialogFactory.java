...
public final class DialogFactory {
    ...
    public static Dialog createSimpleOkDialog(Context context, String title, String message) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(context).setTitle(title).setMessage(message).setNeutralButton(R.string.error_data_empty, null);
    ...
    public static Snackbar showErrorSnackBar(Context mContext, View rootView, Throwable throwable) {
        String message = mContext.getString(R.string.string_hotspot_notif);
        if (throwable != null) {
        ...
        tv.setTextColor(ContextCompat.getColor(mContext, R.color.cardview_dark_background));
        return snack_error;
    }
